...
\begin{flalign*}
&\binom{k}{\alpha_{j_1}} \binom{k - \alpha_{j_1}}{\alpha_{j_2}} \ldots \binom{k - \alpha_{j_1} - \ldots - \alpha_{j_{m-1}}}{\alpha_{j_m}} = \frac{k!}{\alpha_{j_1}! \cancel{(k - \alpha_{j_1})!}} \frac{\cancel{(k-\alpha_{j_1})!}}{\alpha_{j_2}!\cancel{(k - \alpha_{j_1} - \alpha_{j_2})!}} \frac{\cancel{(k - \alpha_{j_1} - \alpha_{j_2})!}}{\alpha_{j_3}! \cancel{(k - \alpha_{j_1} - \alpha_{j_2} - \alpha_{j_3})!}} \ldots & &\\
&\cdot \frac{\cancel{(k - \alpha_{j_1} - \ldots - \alpha_{j_{m-2}})!}}{\alpha_{j_{m-1}}! \cancel{\alpha_{j_m}!}} \frac{\cancel{\alpha_{j_m}}}{\alpha_{j_m}! 0!} = \frac{k!}{\alpha_{j_1}! \alpha_{j_2}! \ldots \alpha_{j_m}!} = \binom{k}{\bm{\alpha}}
\end{flalign*}
