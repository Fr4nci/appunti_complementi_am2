...
\begin{proof} \hspace{1cm} \\
	...
	\begin{itemize}
		\item $x \in A$;
		\item $x \in \text{Fr} \, A \subseteq A \implies x \in A \implies x \in A$
	\end{itemize}
...
\end{exercise}
\begin{proof} \hspace{1cm} \\
	Il fatto che $\bar{A} \subseteq A \cup \text{Fr} \, A$ si ottiene ragionando come nello scorso esercizio. Il viceversa si ottiene dal seguente ragionamento: supponiamo che $\exists x \in A \cup \text{Fr} \, A$ tale che $x \not\in \bar{A}$, allora escludiamo che $x \not\in A$ siccome $A \subseteq \bar{A}$. Dunque $x \in \text{Fr} \, A$ ma $\forall x \in \text{Fr} \, A$ abbiamo che
