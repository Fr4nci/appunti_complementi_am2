...
\begin{proof} la dimostrazione verrà fatta, senza perdere di generalità, nel caso delle $1-$forme differenziali. \\
	...
	&=\int_0^1 \left( a_j((1-t)x_0 + tx) + t\frac{\partial}{\partial t}\Bigg|_{t=0} \left[ a_j((1-t)x_0 + tx) \right] \right)dt = \int_0^1 \frac{\partial}{\partial t}\Bigg|_{t=0} \left( ta_j((1-t)x_0 + tx) \right)dt = a_j(x) 
	\end{align*}
