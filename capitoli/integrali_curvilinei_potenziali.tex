...
\end{align*}
possiamo effettuare un cambio di variabile nella seconda sommatoria con $j' = j -k $ (tuttavia indicheremo nella sommatoria sempre $j$ siccome gli indici sono muti in una sommatoria), pertanto
\begin{align*}
