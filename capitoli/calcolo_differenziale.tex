...
$$
e consideriamo $|x-x_0| < \delta_\varepsilon$ tale che $|df(x_0)(x-x_0) + o(|x-x_0|)| < \sigma_{\varepsilon}$. Sappiamo allora, per definizione di $o-$piccolo, che $\exists \bar{\delta}_\varepsilon > 0: |f(x) - f(x_0)| < \varepsilon |x-x_0|$, dunque prendiam
$|x - x_0| < \min(\delta_\varepsilon, \bar{\delta}_\varepsilon)$ affinché valgano entrambe le disuguaglianze dette sopra e, a questo punto, facendo qualche piccola minorazione possiamo dedurre che 
\begin{align*}
...
&=f(x_0 + te_i + te_j) - f(x_0 + te_i) - f(x_0 + te_j) + f(x_0)
\end{align*}
...
\begin{align*}
[\partial_{x_i} f(x_0 + \theta te_i + te_j) - \partial_{x_i} f(x_0 + \theta te_i)]t = [\partial_{x_i} (f(x_0 + \theta te_i + te_j) - f(x_0 + \theta te_i))]t = \\
=\partial_{x_i} (\partial_{x_j} f) (x_0 + \theta t e_i + te_j)t^2
\end{align*}
