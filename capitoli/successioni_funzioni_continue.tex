...
\exists x_{\alpha_1 \ldots \alpha_n(k)} \to x = (x_1, \ldots, x_n)$ (il fatto di poter estrarre una successione convergente è conseguenza del teorema di Bolzano-Weierstrass) e $x \in E$ per la chiusura di $E$. Il fatto di poter estrarre delle sottosuccessioni convergenti è garantito dal teorema di Bolzano-Weierstrass.
\end{proof}
