...
\begin{proof}[Dimostrazione (del corollario)]
	Siccome $m_n: \mathcal{M}(\mathbb{R}^n) \to [0; +\infty]$ allora $\mathcal{M}(\mathbb{R}^n)$ è una $\sigma-$algebra, dunque se $A \in \mathcal{M}(\mathbb{R}^n) \implies A^c \in \mathcal{M}(\mathbb{R}^n)$.
\end{proof}
\begin{cor}
	Tutte le unioni e le intersezioni numerabili di insiemi chiusi o aperti sono ancora misurabili secondo Lebesgue
\end{cor}
\begin{proof}
	Se $\{ B_i : i \geq 1 \} \subseteq \mathcal{M}(\mathbb{R}^n) \implies \bigcup\limits_{i=1}^{+\infty} B_i \in \mathcal{M}(\mathbb{R}^n)$ perché $\mathcal{M}(\mathbb{R}^n)$ è una $\sigma-$algebra, mentre per le intersezioni numerabili abbiamo che se $B_i \in \mathcal{M}(\mathbb{R}^n) \implies B_i^c \in \mathcal{M}(\mathbb{R}^n)$ (sempre per le proprietà delle $\sigma-$algebre)
	e, per le leggi di De Morgan, avremo che $\left(\bigcup\limits_{i=1}^{+\infty} B_i^c \right)^c = \bigcap\limits_{i=1}^{+\infty} B_i \in \mathcal{M}(\mathbb{R}^n)$
\end{proof}
...
Sia $E \in \mathcal{M}(\mathbb{R}^n)$ misurabile e $f: E \to \bar{\mathbb{R}}$. Diremo che $f$ è misurabile secondo Lebesgue se $\forall t \in \mathbb{R}$ l'insieme $f^{-1}([-\infty, t)) \in \mathcal{M}(\mathbb{R}^n)$, ovvero esso è misurabile.
\end{definition}
...
\begin{prop}[caratterizzazione delle funzioni misurabili]
	$E \in \mathcal{M}(\mathbb{R}^n), f: E \to \bar{\mathbb{R}}$ è misurabile se e solo se $\forall O \subseteq \bar{\mathbb{R}}$ aperto di $[-\infty, +\infty]$ abbiamo che $f^{-1}(O) \in M(\mathbb{R}^n)$
\end{prop}
...
\begin{proof}
	...
	$$
	f^{-1}(0) = E \cap \Omega \in \mathcal{M}(\mathbb{R}^n) \implies f \text{ è misurabile }
	$$
	ovvero la tesi.
\end{proof}
\begin{prop}
