...
\end{tikzpicture}
	...
	\end{itemize}
	\subfile{capitoli/spazi_euclidei}
	\subfile{capitoli/successioni_funzioni_continue}
	\subfile{capitoli/calcolo_differenziale}
	\subfile{capitoli/curve_superfici_regolari}
	\subfile{capitoli/integrali_curvilinei_potenziali}
	\subfile{capitoli/integrali_curvilinei_potenziali.tex}
	\subfile{capitoli/cenni_misura_lebesgue}
	\begin{appendices}
		\subfile{capitoli/notazione_multi_indice}
	\end{appendices}
\end{document}