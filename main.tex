...
Sia $f: \Omega \to \mathbb{R}, \Omega$ aperto e $\Omega \subseteq \mathbb{R}^n$ fino all'ordine $k$ e siano continue in $\xi \in \Omega$. Allora per ogni scelta di indici $1 \leq i_1, \ldots, i_k \leq n$ abbiamo
$$
...
$$
C^k (\Omega) = \{ f: \Omega \to \mathbb{R}: \forall l \in \{1, \ldots k\} \, \exists \partial_{x_{i_1}} \partial_{x_{i_2}} \partial_{x_{i_3}} \ldots 
$$
\end{definition}
