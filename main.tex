...
\end{definition}
\section{Punti critici su curve e su superfici regolari}
...
$$
V_{x_0} = \{ v \in \mathbb{R}^n: \gamma \in C^{1}((-\varphi, \varphi), \Sigma), \dot{\gamma}(0) = v, \gamma(0) = x_0 \}
$$
\end{definition}
...
\end{theorem}
\begin{proof}
Se $\gamma \in C^{1}((-\varepsilon, \varepsilon), \Sigma)$ tale che $\gamma(0)=x_0$ e $g^{-1}(g(x_0)) = \Sigma \implies g(\gamma(t)) = \gamma(x_0)$
\end{proof}
